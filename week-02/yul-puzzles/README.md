...
1. [SError (6275): Source "lib/forge-std/src/Test.sol" not found: File not found. Searched the following locations: "/Users/ivan_s/Documents/security-research/sr-study-plan/week-02/yul-puzzles".
ParserError: Source "lib/forge-std/src/Test.sol" not found: File not found. Searched the following locations: "/Users/ivan_s/Documents/security-research/sr-study-plan/week-02/yul-puzzles".
 --> test/WriteTwoDynamicArraysToStorage.t.sol:4:1:
  |
4 | import {Test, console} from "forge-std/Test.sol";
  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Error: Compilation failed
simpleRevert](./src/SimpleRevert.sol)
...
26. [WWriteToMappingriteToMapping](./src/WriteToMapping.sol) 
